...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_genre', models.CharField(choices=[('AR', 'Article'), ('NW', 'News')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='news.author')),
